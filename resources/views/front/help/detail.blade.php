        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb_wrapper d-flex flex-column align-items-center">
                    <h4 class="page_title">{{ __('global.aboutUS') }}</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-bottom-30">
                            <li class="breadcrumb-item"><a href="{{ route('help') }}">{{ __('global.help') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ __('global.details') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
