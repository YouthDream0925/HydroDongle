...
<div class="container-xl p-5">
    <div class="row justify-content-between align-items-center mb-2">
        <div class="col flex-shrink-0 mb-5 mb-md-0 breadcrumb-custom">
            <h1 class="display-4 mb-0 display-5">{{ __('global.roleTitle') }} - {{ __('global.edit') }}</h1>
        ...
        <div class="col-lg-12">
            <div class="card card-raised mb-5">
                <div class="card-body p-5">
                    ...
                    <div class="row">
                        <div class="mb-4">
                            <mwc-textfield class="w-100" label="Role Name" outlined id="role_name" name="name" value="{{ $role->name }}"></mwc-textfield>
                        </div>
