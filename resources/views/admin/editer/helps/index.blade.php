    ...
    <div class="row justify-content-between align-items-center mb-2">
        <div class="col flex-shrink-0 mb-5 mb-md-0 breadcrumb-custom">
            <div class="d-flex item-center">
                <h1 class="display-4 mb-0 display-5 mr-3">{{ __('global.helpTitle') }}</h1>
                {!! Form::open(['method' => 'GET','route' => ['helps.index']]) !!}
                <div class="d-flex item-center">
            ...
            <a class="btn btn-outline-success mdc-ripple-upgraded" href="{{ route('helps.create') }}">
