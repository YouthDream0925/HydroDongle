                            ...
                            <div class="col-xl-12">
                                <div class="mb-4 d-flex">
                                    ...
                                    <mwc-select class="w-50" name="view_type" outlined label="Views">
                                        <mwc-list-item value="0">Drop-Down</mwc-list-item>
                                        <mwc-list-item value="1">Page</mwc-list-item>
                                    </mwc-select>
                                </div>
                                <div class="mb-4 d-flex">
                                    <div class="w-100 mr-1">
                                        <label class="form-label">Tags Input</label>
                                        <input style="width: 100px;" type="text" class="form-control" data-role="tagsinput" name="tags" value="">
                                    </div>
