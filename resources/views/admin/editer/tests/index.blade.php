...
<div class="container-xl p-5">
    <div class="row justify-content-between align-items-center mb-2">
        <div class="col flex-shrink-0 mb-5 mb-md-0 breadcrumb-custom">
            <div class="d-flex item-center">
                <h1 class="display-4 mb-0 display-5 mr-3">{{ __('global.testTitle') }}</h1>
                {!! Form::open(['method' => 'GET','route' => ['tests.index']]) !!}
                <div class="d-flex item-center">
            ...
            <a class="btn btn-outline-success mdc-ripple-upgraded" href="{{ route('tests.create') }}">
    ...
    <div class="row gx-5">
        ...
        @if(count($tests) != 0)
                                ...
                                <td class="txt-right">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('tests.edit',$test->id) }}"><span class="material-icons">edit</span>{{ __('global.edit') }}</a>
                                            </li>
                                            <li>
            ...
            @include('layouts.admin.pagination.index', ['paginator' => $tests])
            @else
