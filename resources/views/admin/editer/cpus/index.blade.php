...
<div class="container-xl p-5">
    <div class="row justify-content-between align-items-center mb-2">
        <div class="col flex-shrink-0 mb-5 mb-md-0 breadcrumb-custom">
            <div class="d-flex item-center">
                <h1 class="display-4 mb-0 display-5 mr-3">{{ __('global.cpuTitle') }}</h1>
                {!! Form::open(['method' => 'GET','route' => ['cpus.index']]) !!}
                <div class="d-flex item-center">
    ...
    <div class="row gx-5">
        <div class="col-lg-12">
            ...
            @include('layouts.admin.pagination.index', ['paginator' => $cpus])
            @else
