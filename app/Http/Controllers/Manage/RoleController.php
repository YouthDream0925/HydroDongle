...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.general.roles.create',compact('permission'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.general.roles.show',compact('role','rolePermissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.general.roles.edit',compact('role','permission','rolePermissions'));
    }
